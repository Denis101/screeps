...
import HarvestComponent, { HarvestComponentMemory } from "./HarvestComponent";

const TYPE: string = 'MineComponent';

@component<CreepComponent>(TYPE_CREEP_COMPONENT, TYPE)
export default class MineComponent implements CreepComponent {
